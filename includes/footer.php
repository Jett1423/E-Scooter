      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <li><a href="index.php">Home</a></li>
            ...
            <li><a href="car-listing.php">E-Scooter</a></li>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 col-md-pull-6">
          <p class="copy-right">Copyright &copy; 2024 E-Scooter Rental Portal. Brought To You By <a href="https://code-projects.org/">RKCL Technology</a></p>
        </div>
      </div>
    </div>
  </div>
