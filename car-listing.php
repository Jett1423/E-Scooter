...
<title>E-Scooter Rental | E-Scooter Listing</title>
<!--Bootstrap -->
...
if ($query->rowCount() > 0) {
    foreach ($results as $result) { ?>
        <div class="product-listing-m gray-bg" data-aos="fade-left" data-aos-delay = 50>
          ...
          <div class="product-listing-content">
            ...
            <p class="list-price">P<?php echo htmlentities($result->PricePerDay); ?> Per Hour</p>
            <ul>
              <li><i class="fa fa-user" aria-hidden="true"></i><?php echo htmlentities($result->SeatingCapacity); ?> person</li>
...
?>
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          <div class="widget_heading" data-aos = "fade-left">
            <h5><i class="fa fa-filter" aria-hidden="true"></i> Pick your E-Scooter! </h5>
          </div>
          <div class="sidebar_filter">
            <form action="search-carresult.php" method="post">
              <div class="form-group select"data-aos = "fade-right" >
        ...
        <div class="sidebar_widget" data-aos = "fade-up">
          <div class="widget_heading">
            <h5><i class="fa fa-car" aria-hidden="true"></i> New Scooters</h5>
          </div>
    ...
    foreach ($results as $result) { ?>
              <li class="gray-bg">
                ...
                <div class="recent_post_title">
                  ...
                  <p class="widget_price">P<?php echo htmlentities($result->PricePerDay); ?> Per Hour</p>
                </div>
              </li>
              <?php 
    }
