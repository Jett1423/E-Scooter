...
<ul>
<li><a href="create-brand.php">Input Brand</a></li>
<li><a href="manage-brands.php">Manage Brands</a></li>
</ul>
</li>

<li><a href="#"><i class="fa fa-sitemap"></i> E-Scooter</a>
					<ul>
						<li><a href="post-avehical.php">Post a E-Scooter</a></li>
						<li><a href="manage-vehicles.php">Manage E-scooters</a></li>
					</ul>
				</li>
