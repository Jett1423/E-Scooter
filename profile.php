...
<title>E-Scooter Rental Portal | My Profile</title>
<!--Bootstrap -->
          ...
          <form  method="post">
           <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-control white_bg datepicker" value="<?php echo htmlentities($result->dob);?>" name="dob" id="birth-date" type="text">
            </div>
            <div class="form-group">
...
$(document).ready(function(){
    $('.datepicker').datepicker({
        format: 'dd/mm/yyyy',  // Set the format to match your expected date format
        autoclose: true
    });
});
</script>
